...
Rama V.1_x64 para arquitecturas de equipo x64/x86
Rama V.1_x32 para aquitecturas de equipo x32 
...
1. Si clonaste el repositorio. Puedes ejecutar directamente el Software en la carpeta RUN, lo puedes abrir dando doble clic
   ejecutando el archivo "DatenJäger_64bits.exe" | Si tu equipo es arquitectura x64 / x86 
...
3. Si tu equipo es x32, considera ver los archivos en la rama V.1_x32bits
